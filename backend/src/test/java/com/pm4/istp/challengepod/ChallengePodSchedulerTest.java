...
import com.pm4.istp.challengepod.services.ChallengePodScheduler;
...
class ChallengePodSchedulerTest {
    ...
    @InjectMocks
    private ChallengePodScheduler scheduler;
    ...
    void reap_skipsWhenNoAdminConfig() {
        ...
        verify(challengePodService, never()).reapExpiredPods(org.mockito.ArgumentMatchers.anyInt());
    }
    ...
    void reap_callsReapWithTtlFromAdminConfig() {
        ...
        verify(challengePodService).reapExpiredPods(1800);
    }
