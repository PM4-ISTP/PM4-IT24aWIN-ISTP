...
import com.pm4.istp.dto.CreateChallengeRequestDto;
import com.pm4.istp.dto.CreateChallengeResponseDto;
import com.pm4.istp.dto.ListChallengeResponseDto;
import com.pm4.istp.dto.UpdateChallengeRequestDto;
import com.pm4.istp.dto.VisibilityImpactResponseDto;
...
class ChallengeControllerTest {
  ...
  void createChallenge_returnsCreatedResponse() {
    ...
    ResponseEntity<CreateChallengeResponseDto> response =
        challengeController.createChallenge(jwt, requestDto);
  ...
  void getChallenge_returnsDtoWithCourseCount() {
    ...
    ResponseEntity<ChallengeDetailResponseDto> response =
        challengeController.getChallenge(jwt, challengeId);
  ...
  void updateChallenge_returnsUpdatedDto() {
    ...
    ResponseEntity<ChallengeDetailResponseDto> response =
        challengeController.updateChallenge(jwt, challengeId, requestDto);
  ...
  void listChallenges_returnsPageFromService() {
    ...
    ResponseEntity<Page<ListChallengeResponseDto>> response =
        challengeController.listChallenges(jwt, pageable);
  ...
  void searchChallenges_delegatesToService() {
    ...
    ResponseEntity<Page<ListChallengeResponseDto>> response =
        challengeController.searchChallenges(jwt, "sql", pageable);
  ...
  void getVisibilityImpact_returnsAffectedCount() {
    ...
    ResponseEntity<VisibilityImpactResponseDto> response =
        challengeController.getVisibilityImpact(jwt, challengeId, ChallengeStatusEnum.DRAFT);
