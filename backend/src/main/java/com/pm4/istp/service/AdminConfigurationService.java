...
public class AdminConfigurationService {
    ...
    public AdminConfigurationService(
        ...
        this.adminConfigRepository = Objects.requireNonNull(
                adminConfigRepository, "adminConfigRepository must not be null");
        this.kubeconfigStorageService = Objects.requireNonNull(
    ...
    private AdminConfig getOrCreateAdminConfig() {
        return adminConfigRepository.findById(SINGLETON_ID)
                .orElseGet(this::createNewAdminConfig);
    }
