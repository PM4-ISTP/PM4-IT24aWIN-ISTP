...
public class SubTaskStudentDto {
  ...
  /**
   * The plaintext flag. Populated only when the requesting user has solved this sub-task or an
   * instructor is retrieving the solutions (FLAG type); {@code null} otherwise.
   */
