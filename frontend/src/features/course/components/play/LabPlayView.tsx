...
import { LabPlayPodPanel } from "@/src/features/course/components/play/LabPlayPodPanel";
    ...
    >
      ...
      >
        ...
        <LabPlayPodPanel
          ...
          podStatus={podStatus}
          podActionLoading={podActionLoading}
          startDisabledReason={startDisabledReason}
          startDisabled={startDisabled}
          canExtendPod={canExtendPod}
          extendDisabledReason={extendDisabledReason}
          podExpiringNow={podExpiringNow}
          podExpiringSoon={podExpiringSoon}
          podTimeLeftLabel={podTimeLeftLabel}
          podExpiresAt={podExpiresAt}
          extensionSummary={extensionSummary}
          labIsStarting={labIsStarting}
          appUrl={pod?.appUrl}
          podActionError={podActionError}
          podStatusError={podStatusError}
          onStartPod={() => void handleStartPod()}
          onStopPod={() => void handleStopPod()}
          onExtendPod={() => void handleExtendPod()}
          onCollapsePanel={() => setLabCollapsed(true)}
        />
      </Box>
    </Box>
  );
