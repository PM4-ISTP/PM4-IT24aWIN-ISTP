...
INSERT INTO public.courses (id, badge_icon, badge_primary_color, badge_template, badge_text_color, created_at, description, image_url, invite_code, status, short_description, title, topic, updated_at, mc_attempts_mode, badge_enabled) VALUES ('81195733-da60-4665-ad05-302bbe9e4724', '🎓', '#4f46e5', 2, '#ffffff', '2026-05-03 09:55:28.331572', '<p>Wir hacken alles LMAO weil der kurs so mega gut ist</p>', NULL, NULL, 'PUBLIC', 'Wir hacken alles LMAO', 'IT Security Kurs von Hausen', NULL, '2026-05-03 11:33:53.45889', 'ONCE', true) ON CONFLICT DO NOTHING;
INSERT INTO public.courses (id, badge_icon, badge_primary_color, badge_template, badge_text_color, created_at, description, image_url, invite_code, status, short_description, title, topic, updated_at, mc_attempts_mode, badge_enabled) VALUES ('11c9da46-a2cc-4362-900b-f375825163c2', '🚀', '#ffffff', 1, '#000000', '2026-05-03 15:49:07.041405', '<p>This course contains hands-on web security challenges that simulate common vulnerabilities found in modern web applications.</p><p>The labs cover topics such as reconnaissance, authentication and authorization flaws, broken access control, IDOR, SSRF, insecure API endpoints, and other practical attack surfaces.</p><p>Each challenge runs as its own vulnerable lab web application. Subtasks and flag submission are handled by the ISTP platform.</p><p></p>', 'https://images.unsplash.com/photo-1667264501379-c1537934c7ab?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', NULL, 'PUBLIC', 'Practice real-world web security vulnerabilities in isolated lab environments.', 'Web Security Labs', 'Web-Security', '2026-05-03 15:49:39.248695', 'ONCE', true) ON CONFLICT DO NOTHING;
INSERT INTO public.courses (id, badge_icon, badge_primary_color, badge_template, badge_text_color, created_at, description, image_url, invite_code, status, short_description, title, topic, updated_at, mc_attempts_mode, badge_enabled) VALUES ('b3e7b146-ba2f-4aef-b77c-4076ad1fd8dd', NULL, NULL, NULL, NULL, '2026-05-03 18:12:47.964964', '<p>Add a description...</p>', NULL, NULL, 'PUBLIC', 'Auto Enrollment Test Short Description', 'Auto Enrollment Test', NULL, '2026-05-03 18:12:47.964964', 'UNLIMITED', true) ON CONFLICT DO NOTHING;
INSERT INTO public.courses (id, badge_icon, badge_primary_color, badge_template, badge_text_color, created_at, description, image_url, invite_code, status, short_description, title, topic, updated_at, mc_attempts_mode, badge_enabled) VALUES ('4d0fd360-5d1b-462b-88ee-39281085698e', NULL, NULL, NULL, NULL, '2026-05-03 19:15:16.052595', '<p>Add a description...</p>', NULL, '2K582G', 'PRIVATE', 'dave test 1', 'dave test 1', NULL, '2026-05-03 19:15:16.052595', 'UNLIMITED', true) ON CONFLICT DO NOTHING;
INSERT INTO public.courses (id, badge_icon, badge_primary_color, badge_template, badge_text_color, created_at, description, image_url, invite_code, status, short_description, title, topic, updated_at, mc_attempts_mode, badge_enabled) VALUES ('2032ea00-5c15-45ca-86df-1184772c8260', NULL, NULL, NULL, NULL, '2026-05-06 10:34:29.600098', '<p>Add a description...</p>', NULL, NULL, 'DRAFT', 'Test', 'TZest', 'Web-Security', '2026-05-06 10:34:29.600098', 'UNLIMITED', true) ON CONFLICT DO NOTHING;
